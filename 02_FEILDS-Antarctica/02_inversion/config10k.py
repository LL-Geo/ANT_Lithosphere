...
lab_name = "./Model/LAB_Submission_Run.csv"

mantle_name= "./Model/Mantle_submission.csv"
...
subsurfaceTags = ["Crust", "CrustPadding", "Mantel1", "Mantel2", "Mantel3", "MantelPadding"]
inversionTags = ["Crust", "CrustPadding", "Mantel1", "Mantel2", "Mantel3"]
